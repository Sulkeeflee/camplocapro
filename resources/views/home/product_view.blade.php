                               ...
                               <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="product/{{$products->image}}">
                                        ...
                                        <div class="product__discount__item__text">
                                            ...
                                            <h5 class="product__item__price"> <a href="#">{{$products->title}}</a></h5>

                                            @if($products->discount!=null)

                                            <div class="product__item__price">฿{{$products->price}}<span>฿{{$products->discount}}</span></div>


                                            @else

                                            <h5 class="product__item__price">฿{{$products->price}}</h5>
